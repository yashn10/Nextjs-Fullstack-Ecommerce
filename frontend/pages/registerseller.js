...
const registerseller = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8000/sellerregister', {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        <div className="container">
            ...
            <h4 style={{ textAlign: "center", paddingTop: "4%", fontSize: "xx-large" }}>Register as a seller</h4>
            ...
            <form method='post' className="col s12" style={{ padding: "2% 20%" }} onSubmit={submit}>
                ...
                <div className='row'>
                    <span>Already Signup? Signin
                        <Link href={'/sellerlogin'}> Here</Link>
                    </span>
